...
principal components and the K matrix (scripts\23_gwas_merged_panel.py, model unchanged).
...
src = (MODELS.parent / "gwas" / "23_gwas_merged_panel.py").read_text(encoding="utf-8")
