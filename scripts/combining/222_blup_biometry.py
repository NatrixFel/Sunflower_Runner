...
The model is the same as for the three productivity traits in 221_parse_hybrid_reps.py:
...
are copied from 222_hybrid_blup_phenotypes.csv WITHOUT changes; two new ones are added.

Input:  deposit 221_hybrid_plot_level.parquet
        deposit 222_hybrid_blup_phenotypes.csv
Output: 222_hybrid_blup_phenotypes_ext.csv
        222_blup_biometry.txt
"""
...
OLD  = OUT / "222_hybrid_blup_phenotypes.csv"
OUT_CSV = OUT / "222_hybrid_blup_phenotypes_ext.csv"
TXT  = OUT / "222_blup_biometry.txt"
