...
Output: phase8_output/22_lines_tidy.parquet, hybrids_tidy_v2.parquet
"""
...
# Save
lines_v2.to_parquet(OUT / "22_lines_tidy.parquet", index=False)
hyb_v2.to_parquet(OUT / "hybrids_tidy_v2.parquet", index=False)
print(f"\nSaved: {OUT}/22_lines_tidy.parquet and hybrids_tidy_v2.parquet")
