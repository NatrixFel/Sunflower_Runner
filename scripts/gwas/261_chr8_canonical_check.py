...
Output: 261_chr8_canonical_check.csv
"""
import sys
...
pd.DataFrame(rows).to_csv(HERE / "261_chr8_canonical_check.csv", index=False, encoding="utf-8-sig")
print("\nWritten: 261_chr8_canonical_check.csv")
